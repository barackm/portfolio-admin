...
const Button = (props: ButtonProps) => {
  ...
  const getBtnClasses = () => {
    const defaultBtnClasses = `inline-block px-5 py-2  font-bold text-center text-white uppercase border ${
    ...
    const textBtnClasses = `inline-block px-5 py-2.5 font-bold text-center uppercase align-middle transition-all rounded-lg cursor-pointer bg-transparent shadow-none border-none leading-pro text-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 ${
      color === 'primary'
